...
$libraryName = Read-Host "Bitte geben Sie den Namen der Dokumentbibliothek ein (z.B.: Dokumente)"
$folderPath  = Read-Host "Bitte geben Sie den Pfad zum Ordner innerhalb der Bibliothek ein (z.B.: 'OrdnerA')"
